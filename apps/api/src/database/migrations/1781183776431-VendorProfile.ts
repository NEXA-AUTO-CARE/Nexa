...
export class VendorProfile1781183776431 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."vendor_profiles_approval_status_enum" AS ENUM('PENDING', 'ACTIVE', 'SUSPENDED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "vendor_profiles" ADD CONSTRAINT "FK_1f5076ae25966a5594e90b41b96" FOREIGN KEY ("vendor_id") REFERENCES "users"("user_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TYPE "public"."vendor_profiles_approval_status_enum"`,
    );
  }
}
