...
export const DEFAULT_BOOKING_TEMPLATES: TemplateMap = {
  booked: {
    ...
    emailBody:
      "Your booking (Ref: {{bookingRef}}) for {{vehicleSummary}} on {{bookingTime}} has been confirmed. We'll notify you when a detailer accepts.",
    smsBody:
  ...
  accepted: {
    ...
    emailBody:
      "Great news! A detailer has accepted your booking (Ref: {{bookingRef}}) for {{vehicleSummary}}. They'll arrive on {{bookingTime}}.",
    smsBody:
  ...
  in_progress: {
    ...
    emailBody:
      'Your detailer is now working on {{vehicleSummary}} (Ref: {{bookingRef}}). Sit back and relax!',
    smsBody:
  ...
  completed: {
    title: 'Wash Complete',
    emailBody:
      "Your {{vehicleSummary}} (Ref: {{bookingRef}}) is looking fresh! Your wash is complete. We'd love to hear your feedback.",
    smsBody:
  ...
  cancelled: {
    ...
    emailBody:
      'Your booking (Ref: {{bookingRef}}) for {{vehicleSummary}} on {{bookingTime}} has been cancelled.',
    smsBody:
